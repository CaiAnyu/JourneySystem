...
<html>
    ...
    <body>
        ...
        <FORM METHOD="post" ACTION=CtrlServlet?method=repassword>    
         ...
         <hr>
            收藏的旅游产品:<p>
            <%=session.getAttribute("showfavourite")%>  <hr>
            预定的旅游产品:<p>
            <%=session.getAttribute("showjourneycart")%>  <hr>
            预定的票:<p>
            <%=session.getAttribute("showticketcart")%>  <hr>
            已付款的旅游产品:<p>
            <%=session.getAttribute("showjourneyorder")%>  <hr>
            已付款的票:<p>
